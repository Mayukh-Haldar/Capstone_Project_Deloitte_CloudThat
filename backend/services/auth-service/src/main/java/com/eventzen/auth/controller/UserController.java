...
public class UserController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiMessageResponse> deactivate(@PathVariable UUID id) {
        userManagementService.deactivateUser(id);
        return ResponseEntity.ok(new ApiMessageResponse("User deactivated"));
    }

    @PatchMapping("/{id}/reactivate")
    public ResponseEntity<ApiMessageResponse> reactivate(@PathVariable UUID id) {
    ...
    public ResponseEntity<ApiMessageResponse> gdprDelete(@PathVariable UUID id) {
        userManagementService.gdprDelete(id);
